About google-cloud-dlp-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-cloud-dlp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-cloud-dlp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-cloud-dlp
# for installing globally
pixi global install google-cloud-dlp
```
...
It is possible to list all of the versions of `google-cloud-dlp` available on your platform:
...
```
pixi search google-cloud-dlp --channel conda-forge
```
